...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWl6YW5tYXBib3giLCJhIjoiY2syajF2ZmVtMG90azNjbzB4NHUxcWRjbiJ9.y8etOA5ldpGA6tdQjZl_RA';
...
exports.shwoAlert = exports.hideAlert = void 0;

// tyep is 'success' or 'error'
...
var shwoAlert = function shwoAlert(type, msg) {
  hideAlert();
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.shwoAlert)('success', 'Logged in successfully');
          ...
          case 7:
            ...
            (0, _alert.shwoAlert)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.shwoAlert)('error', 'Error logging out! Try again');
...
var stripe = Stripe('pk_test_Ced6Vl9qRnD7pL8xsBKHDW1G00cloil9kG');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            (0, _alert.shwoAlert)('error', _context.t0);
